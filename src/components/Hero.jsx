        ...
        <div className="lg:mr-[480px]">
          ...
          >
            <h1
              ...
              font-extrabold mb-8 text-white"
            >
              Crafting Digital Experiences
            </h1>

            <p className="lg:max-w-[600px] text-gray-300 leading-relaxed text-justify">
            A passionate developer focused on crafting meaningful digital solutions, 
            I blend creativity with technical expertise to build applications that are both 
            functional and user-centric. From intuitive interfaces to scalable backend systems, 
            I strive to create products that not only work seamlessly but also provide real value to
            their users. My approach is rooted in clean, efficient code and thoughtful design that 
            prioritizes both performance and usability.
            </p>
          </motion.div>
